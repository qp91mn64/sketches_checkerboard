 ...
 * 
 * Grayscale pattern emerges + colored pattern fades in with transparency
 * 
 * Left click: a + 1
 * Right click: a - 1
...
void keyPressed() {
  switch (key) {
    ...
    case '3':
      ...
      break;
    case 's':
        String s = String.format("your_output/c_bitwise_6a_%s_a_%d_s%s.png", bitwiseString, a, stamp());  // For distinction a stamp is used

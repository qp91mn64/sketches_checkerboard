 ...
 * Created: 2026-02-23
 * 
 * Modefied from c_bitwise_8a
 * 
 * Grayscale or opaque
 * Display window with 512x512 pixels 
 * similar to c_bitwise_5
 * But you can drag or use arrow keys to explore different parts now
...
void keyPressed() {
  if (key == CODED) {
    ...
    if (key == '1') {
      ...
      String s = String.format("your_output/c_bitwise_9_%s_a_%d_xOffset_%d_yOffset_%d_s%s.png", bitwiseString, a, xOffset, yOffset, stamp());  // For distinction a stamp is used
